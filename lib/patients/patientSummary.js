...
function getPatientSummary(patientId, sessions, callback) {
...
function patientSummary(patientId, callback) {
  ...
  if (patientHeadings.exists) {
    ...
    var summary = formatSummary.call(this, patientId);
  ...
  openEHR.startSessions(function(sessions) {
    openEHR.mapNHSNo(nhsNo, sessions, function() {
      getPatientSummary.call(q, patientId, sessions, function() {
        openEHR.stopSessions(sessions);
        var summary = formatSummary.call(q, patientId);
        if (callback) callback(summary);
