...
module.exports = {
  ...
  getPatientSummary: function(args, callback) {
    patientSummary.get.call(this, args.patientId, callback);
  },
  getHeadingTable:  function(args, callback) {
    patientHeadingTable.call(this, args.patientId, args.heading, callback)
  },

  getHeadingDetail: function(args, callback) {
    var results = patientHeadingDetail.call(this, args.patientId, args.heading, args.sourceId);
    callback(results);
  },
