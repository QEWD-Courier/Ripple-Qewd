...
module.exports = {
  ...
  getPatientSummary: function(patientId, callback) {
    patientSummary.get.call(this, patientId, callback);
  },
  getHeadingTable:  function(patientId, heading, callback) {
    patientHeadingTable.call(this, patientId, heading, callback)
  },

  getHeadingDetail: function(patientId, heading, sourceId) {
    return patientHeadingDetail.call(this, patientId, heading, sourceId)
  },
