...
function patientHeadingDetail(patientId, heading, sourceId) {

  console.log('*** patientHeadingDetail - heading = ' + heading);
  ...
  if (!patientHeadingIndex.exists) {
    ...
    openEHR.startSessions(function(sessions) {
      ...
      openEHR.mapNHSNo(nhsNo, sessions, function() {
        ...
        getSelectedHeading(patientId, heading, sessions, function() {
          // now try again!
          console.log('**** trying again!');
          patientHeadingDetail.call(q, patientId, heading, sourceId);
        });
      });
    });
    return;
