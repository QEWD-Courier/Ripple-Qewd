...
function deleteSessionCaches(patientId, heading) {

  // delete cached heading data in all active sessions

  var sessions = this.sessions.active();
  sessions.forEach(function(session) {
    sessions.data.$(['patients', patientId, 'headings', heading]).delete();
    sessions.data.$(['patients', patientId, 'headingIndex', heading]).delete();
  });
}
