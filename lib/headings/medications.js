...
module.exports = {
  ...
  post: {
    ...
    fieldMap: {
      ...
      'current_medication_list/medication_and_medical_devices:0/current_medication:0/medication_statement:0/medication_item/route:0|code': {
        field: 'route'
      },
      'current_medication_list/medication_and_medical_devices:0/current_medication:0/medication_statement:0/medication_item/route:0|value': {
        default: 'RouteValue'
      },
      ...
      'current_medication_list/medication_and_medical_devices:0/current_medication:0/medication_statement:0/medication_item/course_details/start_datetime': {
        default: function(data) {
          ...
          var startTime = dateTime.msSinceMidnight(data.startTime) + 3600000;
