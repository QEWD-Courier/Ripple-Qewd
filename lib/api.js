...
var contentStoreRest = require('qewd-content-store').rest;
var createSession = require('./sessions/create');
//var documents = require('./documents/documents');
var documents = require('./documents/docs');
var application = require('./application/application');
var pictures = require('./pictures/endpoints');
...
module.exports = {
  ...
  init: function() {
    ...
    contentStoreRest.init.call(this);
  ...
  handlers: {
    ...
    checkToken: function(messageObj, session, send, finished) {
      ...
      */
      ...
      if (!expired) {
        ...
        session.timeout = this.userDefined.sessionTimeout || 900;
    ...
    authenticate: function(messageObj, session, send, finished) {
      ...
      mpv.getPatients.call(this, {session: session}, function(patients) {
    ...
    application: function(messageObj, finished) {
      application.api.call(this, messageObj, finished);
    },
    pictures: function(messageObj, finished) {
      pictures.api.call(this, messageObj, finished);
    },
    ...
    contentStore: function(messageObj, finished) {
      contentStoreRest.api.call(this, messageObj, finished);
    },
    ...
    'auth0-register': function(messageObj, finished) {
      ...
      console.log('*** api.js - creating new session');
