...
var putHeading = require('./patients/putHeading');
...
var editTransferOfCare = require('./events/editTransferOfCare');
...
var oauthTest = require('./auth0/test');
var logout = require('./auth0/logout');
...
module.exports = {
  ...
  init: function() {
    ...
    routes = [
      ...
      {
        url: '/api/patients/:patientId/top3Things',
        method: 'POST',
        handler: postTop3Things
      },
      {
        url: '/api/patients/:patientId/top3Things',
        method: 'GET',
        handler: getTop3ThingsSummary
      },
      {
        url: '/api/patients/:patientId/top3Things/:sourceId',
        method: 'PUT',
        handler: postTop3Things
      },
      {
