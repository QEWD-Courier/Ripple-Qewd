...
function toDetail(source, openEhrDocument) { 
    ...
    for (var openEhrFieldName in documentHandler.fieldMap) {
        ...
        //console.log('---> toRippleDocument openEhrFieldName - ' + openEhrFieldName + ' rippleFieldName - ' + canonicalFieldName + ' childFieldMap - ' + childFieldMap);  

        if(childFieldMap) {     
            canonicalDocument[canonicalFieldName] = [];
            //console.log('---> toRippleDocument childFieldMap');
            for(var element in openEhrDocument) {
                if(element.startsWith(openEhrFieldName)) {
                    ...
                    for(var childEhrFieldName in childFieldMap) {
                        //console.log('---> toRippleDocument list childEhrFieldName ' + childEhrFieldName + ' element ' + element);
                        if(element.endsWith(childEhrFieldName)) {
                            var childRippleFieldName = childFieldMap[childEhrFieldName].field;
                            //console.log('---> toRippleDocument list childEhrFieldName ' + childEhrFieldName + ' element ' + element + ' childRippleFieldName ' + childRippleFieldName + ' childElement ' + childElement);
